...
def import_jobs_to_db():
    ...
    try:
        ...
        # In n8n, previous node data would be available
        # For standalone testing, we'll get the latest parsed data
        # In actual n8n workflow, this would come from previous node
        ...
        # In real n8n workflow, jobs would come from previous node
        # For testing, let's check if we have a temporary file with jobs
